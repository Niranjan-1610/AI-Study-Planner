...
>(({ className, variant, ...props }, ref) => {
  ...
  const defaultSuggestions: Suggestion[] = [
    ...
    },
    {
      ...
      title: "Optimize week",
      detailedSuggestion:
        "Rebalance my weekly plan to fit 10 hours total this week.",
      messageId: "planner-copilot-optimize-week",
    },
    {
      id: "planner-copilot-3",
      title: "Next focus",
      detailedSuggestion:
        "What should I study next based on my progress so far?",
      messageId: "planner-copilot-next-focus",
    },
  ];
